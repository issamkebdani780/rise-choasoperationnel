        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 pb-20 border-b border-slate-100 dark:border-slate-800 mb-20">
          ...
          <div className="lg:col-span-5 space-y-8">
            <a href="#" className="flex items-center gap-3">
              <img src="/ecosystem/risemanager.png" alt="RiseManager" className="w-12 h-12 object-contain shrink-0" />
              <span className="text-2xl lg:text-3xl font-black text-slate-900 dark:text-white tracking-tight transition-colors">RiseManager</span>
            </a>
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/risecartgroup" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-slate-400 dark:text-slate-500 hover:bg-blue-600 dark:hover:bg-blue-600 hover:text-white transition-all border border-slate-100 dark:border-slate-800 shadow-sm hover:-translate-y-1">
              ...
              <a href="https://www.instagram.com/risegroup.ecom/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-slate-400 dark:text-slate-500 hover:bg-pink-600 dark:hover:bg-pink-600 hover:text-white transition-all border border-slate-100 dark:border-slate-800 shadow-sm hover:-translate-y-1">
              ...
              {[['fr', 'FR'], ['en', 'EN'], ['ar', 'ع']].map(([code, label]) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-black transition-all ${
                    ...
                    : 'bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-400 border border-slate-100 dark:border-slate-800 hover:text-primary dark:hover:text-white'
                  }`}
                >
                  {label}
                </button>
